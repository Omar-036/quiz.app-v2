...
})({"3OIuj":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "1d2c52f70bc92e2d";
"use strict";
...
},{}],"d5q62":[function(require,module,exports) {
$(function() {
    "use strict";
    // GLOBAL VARIABLES
    $.holdReady(true);
    ...
    $.getJSON("../json/materials.json", function(data) {
      ...
      style="background-image:linear-gradient(to left, rgba(#000, 0.6), rgba(#000, 0.4)), url(img/${materialInfo.img})">
        <h2 class="material__name">${materialInfo.arabicName}<br>${materialInfo.englishName}</h2>
        <p class="material__date">أخر تعديل <span> ${materialInfo.date}</span></p>
        <p class="material__author">الاسم <span>${materialInfo.author}</span></p>
      ...
      `;
            ...
            // $(material).show();
            $(`.material-box--${index + 1}`).css("background-image", `url(../img/${materialInfo.img}`);
        });
        materialObserver();
    }).fail(function() {
        ...
        if ($(window).width() <= 1000) {
            ...
            const revialMaterial = function(entries, observer) {
                ...
                $(entries).each(function(index, entry) {
                    if (entry.isIntersecting) $(entry.target).removeClass("material-box--hidden");
                });
...
},{}]},["3OIuj","d5q62"], "d5q62", "parcelRequire94c2")

//# sourceMappingURL=index.0bc92e2d.js.map
